...
/*-----------------------------------------------------------------
 * Function:     Odd_even_sort_smart
 * Purpose:      Sort list using odd-even transposition sort
 *               if the list is already sorted we leave the function
 * In args:      n
 * In/out args:  a
 */
void Odd_even_sort_smart(
      int  a[]  /* in/out */, 
      int  n    /* in     */) {
   int phase, i, temp;
