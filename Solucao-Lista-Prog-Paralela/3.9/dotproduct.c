...
void Get_Sizes (char *argv[], int scount[], int displ[], int *n, \
...
void Get_Args (char *argv[], int argc, int scount[], int displ[], int *n, \
                const int my_rank, const int comm_sz)
{
    if (my_rank == 0)
    {
...
int main (int argc, char *argv[]) 
{
    ...
    Get_Args(argv,argc,scount,displ,&n,my_rank,comm_sz);
